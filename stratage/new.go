...
func (p *Stratage) AutoUpdateBalance() {
...
func (p *Stratage) AutoStratage() {
	log.Logger.Infof("start auto Stratage")
	var (
		err    error
		quote  *model.Quote
		price  string
	...
	for {
		<-p.shuadanChan
		log.Logger.Infof("start Stratage")
